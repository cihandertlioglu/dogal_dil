...
all_text = ' '.join(df['comment_text'].dropna().astype(str)) 
...
plt.title("Maç Özetleri Metinleri İçin Zipf Yasası")
...
plt.xlabel("Kelime Sırası (log)")
plt.ylabel("Frekans (log)")
plt.title("Maç Özetleri Metinleri Stemmed İçin Zipf Yasası")
plt.grid(True, which="both", linestyle="--", linewidth=0.5)
plt.show()
...
plt.xlabel("Kelime Sırası (log)")
plt.ylabel("Frekans (log)")
plt.title("Maç Özetleri Metinleri Lemmatize İçin Zipf Yasası")
plt.grid(True, which="both", linestyle="--", linewidth=0.5)
plt.show()
